...
const (
	...
	// MaskLimit is the upper limit to avoid hitting datapath
	// complexity issues upon regeneration.
	MaskLimit = 64
)
...
func (r *Recorder) triggerDatapathRegenerate() error {
	// Check out MaskLimit and unroll if needed emit macro and
	// regenerate. Checking MaskLimit here is okay given we need
	// to unwind also when regeneration failed.
	return nil
}
